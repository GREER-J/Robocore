...
conn = comms_fac.create_comms(
    config['conn'], command_fun=tclab_sim.pass_command_to_sim)
...
tclab = Plant(tclab_sim.time_keeper, EventManager(
    5, tclab_sim.time_keeper), sensors, actuators)
